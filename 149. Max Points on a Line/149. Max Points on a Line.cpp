// 149. Max Points on a Line.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
            ...
            for (int j = 0; j < points.size(); j++)
            {
                if (i != j)
                {
                    ...
                    for (int k = 0; k < points.size(); k++)
                    {
                        if (i != k && j != k)
                        {
                            if (((float)(points[i][1] - points[j][1]) /
                                 (float)(points[i][0] - points[j][0])) == 
                                ((float)(points[i][1] - points[k][1]) /
                                 (float)(points[i][0] - points[k][0])))
                            {
                                counter++;
                            }
                        }
...
int main()
{
    ...
    //vector<vector<int>> points = { {4,5}, {4,-1},{4,0 } };
    //vector<vector<int>> points = { {3,3}, {1,4},{1,1},{2,1},{2,2} };
